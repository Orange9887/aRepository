...
function MyGame_2() {
    // textures: 
    this.kMinionSprite = "assets/Consolas-72.png";  // Portal and Collector are embedded here
...
gEngine.Core.inheritPrototype(MyGame_2, Scene);

MyGame_2.prototype.loadScene = function () {
    // loads the textures
...
MyGame_2.prototype.unloadScene = function () {
...
MyGame_2.prototype.initialize = function () {
    ...
    this.mSqSet_lt.getXform().setPosition(11, 69);
    ...
    this.mSqSet_lb.getXform().setPosition(11, 51);
    ...
    this.mSqSet_rt.getXform().setPosition(29, 69);
    ...
    this.mSqSet_rb.getXform().setPosition(29, 51);
    ...
    this.mSqSet_t.setColor([0.5, 1, 0, 0.6]);
    ...
    this.mFrame.getXform().setSize(18,18);
    ...
    this.mFrame_2.getXform().setSize(2.98,2.98);
    ...
    this.mPortal.getXform().setSize(18, 18);
    this.mPortal.setElementPixelPositions(0, 512, 0, 512);
};

// This is the draw function, make sure to setup proper drawing environment, and more
// importantly, make sure to _NOT_ change any state.
MyGame_2.prototype.draw = function () {
...
MyGame_2.prototype.update = function () {
    ...
    if(gEngine.Input.isKeyPressed(gEngine.Input.keys.W))
    {
        ...
        if((xform.getYPos()+xform.getHeight()/2)>69)
        {
            xform.incYPosBy(-deltaX);
            line2.incYPosBy(-deltaX);
            Camera_2.incWCCenterY(-deltaX);
    ...
    if(gEngine.Input.isKeyPressed(gEngine.Input.keys.S))
    {
        ...
        this.mSqSet_l.getXform().incYPosBy(-deltaX);
        this.mSqSet_t.getXform().incYPosBy(-deltaX);
        if((xform.getYPos()-xform.getHeight()/2)<51)
        {
            xform.incYPosBy(deltaX);
            line2.incYPosBy(deltaX);
            Camera_2.incWCCenterY(deltaX);
    ...
    if (gEngine.Input.isKeyPressed(gEngine.Input.keys.Up)) {
        ...
        if ((xform.getYPos()+xform.getHeight()/2)>69 || (xform.getYPos()-xform.getHeight()/2)<51) { // this is the right-bound of the window
            xform.incHeightBy(-deltaX_2);
            line2.incHeightBy(-deltaX_2);
                    this.mSqSet_t.getXform().incYPosBy(-deltaX_2/2);
        this.mSqSet_b.getXform().incYPosBy(deltaX_2/2);
