...
gEngine.ResourceMap = (function () {
    ...
    */
    ...
    var setGlobalCamera = function (temp) {
        mResourceMap['GlobalCamera'] = temp;
    };
    
    var getGlobalCamera = function () {
        if (!('GlobalCamera' in mResourceMap)){
            mResourceMap['GlobalCamera'] = new Camera(
                [20, 60],  // position of the camera
                25,                        // width of camera
                [40,360,200,100]                  // viewport (orgX, orgY, width, height)
                );
            mResourceMap['GlobalCamera'].setBackgroundColor([0.3,0.8,0,4,1]);
        }
        return mResourceMap['GlobalCamera'];
    };
    //</editor-fold>
    ...
    var mPublic = {
        ...
        //</editor-fold>
        setGlobalCamera :setGlobalCamera,
        getGlobalCamera : getGlobalCamera
